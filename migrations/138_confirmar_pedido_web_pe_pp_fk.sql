-- MIG-138 — confirmar_pedido_web: Pronta entrega sin FK pp_id + validar PP tránsito
-- Fix: factura_interna_pp_id_fkey al confirmar carrito con pp_id sintético negativo (PE)
...
COMMENT ON FUNCTION public.confirmar_pedido_web IS
  'MIG-138: PE sin FK pp_id · valida PP tránsito · decrementa stock_pronta_entrega_rimec';

COMMIT;

SELECT 'MIG-138 OK: confirmar_pedido_web PE + FK pp_id' AS estado;
