#!/usr/bin/env python
"""OT-2026-049: Ejecutar migración 013 - Poblar genero en linea"""
...
print('='*80)
print('OT-2026-049: POBLANDO COLUMNA GENERO EN TABLA LINEA')
print('='*80)
...
try:
    with engine.begin() as conn:
        ...
        # Leer y ejecutar SQL
        with open('migrations/013_poblar_genero_linea.sql', 'r', encoding='utf-8') as f:
            sql_content = f.read()
        ...
        print('\n' + '='*80)
        print('[OK] MIGRACION 013 COMPLETADA')
        print('='*80)
